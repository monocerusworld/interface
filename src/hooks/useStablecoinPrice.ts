...
const STABLECOIN_AMOUNT_OUT: { [chainId: number]: CurrencyAmount<Token> } = {
  [SupportedChainId.MANTA]: CurrencyAmount.fromRawAmount(USDC_MANTA, 100_000e6),
  [SupportedChainId.MANTA_TESTNET]: CurrencyAmount.fromRawAmount(USDC_MANTA_TESTNET, 10_000e6)
}
