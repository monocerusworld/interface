...
export const BASES_TO_CHECK_TRADES_AGAINST: ChainTokenList = {
  ...
  [SupportedChainId.GNOSIS]: [
    ...WRAPPED_NATIVE_CURRENCIES_ONLY[SupportedChainId.GNOSIS],
    BTC_GNOSIS,
    USDC_GNOSIS,
    USDT_GNOSIS,
    DAI_GNOSIS,
  ...
  [SupportedChainId.MOONBEAM]: [
    ...WRAPPED_NATIVE_CURRENCIES_ONLY[SupportedChainId.MOONBEAM],
    USDT_MOONBEAM,
    USDC_MOONBEAM,
    WGLMR_MOONBEAM,
    WBTC_MOONBEAM,
  ...
  [SupportedChainId.KLAYTN]: [
    ...WRAPPED_NATIVE_CURRENCIES_ONLY[SupportedChainId.KLAYTN],
    BTC_KLAYTN,
    DAI_KLAYTN,
    USDC_KLAYTN,
    USDT_KLAYTN,
...
export const COMMON_BASES: ChainCurrencyList = {
  ...
  [SupportedChainId.FANTOM]: [nativeOnChain(SupportedChainId.FANTOM), BTC_FANTOM, DAI_FANTOM, USDC_FANTOM, USDT_FANTOM],
  [SupportedChainId.GNOSIS]: [nativeOnChain(SupportedChainId.GNOSIS), BTC_GNOSIS, USDC_GNOSIS, USDT_GNOSIS, DAI_GNOSIS],
  [SupportedChainId.MOONBEAM]: [
  ...
  [SupportedChainId.KLAYTN]: [nativeOnChain(SupportedChainId.KLAYTN), BTC_KLAYTN, DAI_KLAYTN, USDC_KLAYTN, USDT_KLAYTN],
}
