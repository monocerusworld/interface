...
import { ARBITRUM_LIST, CELO_LIST, PLASMA_BNB_LIST } from './lists'
...
const CHAIN_INFO: ChainInfoMap = {
  ...
  [SupportedChainId.OPTIMISM]: {
    ...
    defaultListUrl: ARBITRUM_LIST, // to do
  ...
  [SupportedChainId.MANTA]: {
    networkType: NetworkType.L2,
    blockWaitMsBeforeWarning: ms`10m`,
    bridge: 'https://app.rhino.fi/',
    docs: 'https://docs.manta.network',
    explorer: 'https://pacific-explorer.manta.network/',
    infoLink: 'https://info.uniswap.org/#/manta/',
    label: 'Manta',
    logoUrl: celoLogo,
    circleLogoUrl: bnbCircleLogoUrl,
    squareLogoUrl: bnbSquareLogoUrl,
  ...
  [SupportedChainId.MANTA_TESTNET]: {
    ...
    bridge: 'https://app.rhino.fi/',
    docs: 'https://docs.manta.network',
    explorer: 'https://pacific-explorer.testnet.manta.network/',
    infoLink: 'https://info.uniswap.org/#/manta/',
    label: 'Manta Testnet',
    logoUrl: bnbLogo,
    circleLogoUrl: bnbCircleLogoUrl,
    squareLogoUrl: bnbSquareLogoUrl,
    nativeCurrency: { name: 'WMANTA', symbol: 'MANTA', decimals: 18 },
    defaultListUrl: PLASMA_BNB_LIST,
    color: darkTheme.chain_56,
    backgroundColor: darkTheme.chain_56_background,
  },
